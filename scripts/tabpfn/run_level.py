# Migrated from approach1_tabpfn_bash_probs.py (Chapter 4, Section 4.3).
...
TARGET = "nrtg"                 # choose "nrtg" or "rtg" as the target variable for prediction
HISTORY_WINDOW_MONTHS = 2       # Set the history window in months  # try 2, 3, 6 as well
...
def main():
    ...
    file_path = f"{OUT_DIR}/tabpfn_data_{TARGET}_{HISTORY_WINDOW_MONTHS}_wprobs.csv"
